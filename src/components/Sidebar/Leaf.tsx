...
function Leaf({item}:any) {
  ...
  return (
    <div onClick={()=>{navigate(item.to)}} className={`flex items-center space-x-5 overflow-hidden cursor-pointer p-1 ${sideBarExpanded.value && 'hover:bg-[#3c3c3c] hover:rounded-md'} ${window.location.pathname===item.to ?"bg-[#606060] rounded-md p-1":""}`}>
