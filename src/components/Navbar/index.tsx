...
function Navbar() {
  return (
    <div className="bg-Black-primaryBlack h-[60px] w-full text-white fixed z-50 flex justify-between items-center">
      <div className="pl-[10px] flex items-center">
        <div
          className="hover:bg-[#606060] hover:rounded-md p-1 cursor-pointer w-fit h-fit"
          onClick={() => {
      ...
      <div className="pr-10 flex space-x-5 items-center">
        <DropDown
          ...
          titleClassName="text-[#4285F4] hover:bg-[#303030] font-semibold text-sm cursor-pointer  px-5 py-[5px] rounded-md font-Montserrat hover:bg-Black-hoverBlack"
